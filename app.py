...
def colorizer(img):
    ...
    prototxt = r"D:\Ai Black and white image colorization with OpenCV\models\models_colorization_deploy_v2.prototxt"
    model = r"D:\Ai Black and white image colorization with OpenCV\models\colorization_release_v2.caffemodel"
    points = r"D:\Ai Black and white image colorization with OpenCV\models\pts_in_hull.npy"
